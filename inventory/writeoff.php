...
<?php require "header.php"; ?>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Write-Off Equipment </h4>
                                ...
                                <div class="table-responsive m-t-40" id="tabelastock">
                                    <table id="example" class="table display table-bordered table-striped">
                                        ...
                                        <tbody style="color:#222">
                                            <?php
											if(isset($_GET['id'])){
												$table=$db->prepare("SELECT * FROM abate WHERE nome LIKE ? OR serial LIKE ?");
												$table->execute(array("%".$_GET['id']."%","%".$_GET['id']."%"));
											}else{
												$table=$db->prepare("SELECT * FROM abate");
												$table->execute(array());
											}
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © <?php echo date('Y'); ?> All rights reserved. Created by <a href="#">IT Department</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
