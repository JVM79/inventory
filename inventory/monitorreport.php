            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Monitors report </h4>
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="table display table-bordered table-striped">
                                        ...
                                        <tbody style="color:#222">
                                            <?php
											$table=$db->prepare("SELECT a.*, c.* FROM monitors as a LEFT JOIN alocs as b ON a.name=b.name LEFT JOIN locations as c ON b.location=c.location");
											$table->execute(array());
